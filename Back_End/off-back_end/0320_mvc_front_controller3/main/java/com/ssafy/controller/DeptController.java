...
public class DeptController implements Controller{
	...
	public Object handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		}else if("dept/rest/list".equals(action)) {
	...
	private PageInfo modifyDept(HttpServletRequest request, HttpServletResponse response) 
			throws Exception{
		String deptno = request.getParameter("deptno");
		String dname = request.getParameter("dname");
		String loc = request.getParameter("loc");
		...
		Dept dept = new Dept(Integer.parseInt(deptno), dname, loc);
		boolean result = deptService.modifyDept(dept);
		
		return new PageInfo(false, "/main?action=dept/list");
	}
	
	private PageInfo removeDept(HttpServletRequest request, HttpServletResponse response) 
			throws Exception{
		int deptno = Integer.parseInt(request.getParameter("deptno"));
