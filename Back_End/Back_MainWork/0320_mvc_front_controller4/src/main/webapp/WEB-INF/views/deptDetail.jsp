<%@page import="com.ssafy.model.dto.Dept"%> <!-- 필요 없음 -->
        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="dname" id="dname" value="${requestScope.dept.name}"/></td>
                </tr>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        ...
                        <input type="submit" value="삭제" formaction="main?action=dept/remove"/>
