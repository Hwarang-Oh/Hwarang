  ...
  <body>
    ...
    <div class="container">
      ...
      <form method="post" action="regist" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text">상영 시간</span>
          <input type="number" id="runningTime" name="runningTime" class="form-control" />
        </div>
        <div class="mb-3">
          <label for="file" class="form-label">이미지</label>
          <input type="file" id="file" name="file" class="form-control" accept="image/*" />
        </div>
        <div><input type="submit" value="등록" /> <input type="reset" value="취소" /></div>
      </form>
      <br />
