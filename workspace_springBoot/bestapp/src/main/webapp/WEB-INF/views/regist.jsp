...
<<<<<<< HEAD:tempWorkspace/bestapp/src/main/webapp/WEB-INF/views/regist.jsp
  ...
  <body>
    ...
    <div
      ...
      <form id="registForm" method="post" action="${root}/product/regist">
        ...
        <label for="description">상세설명</label>
        <textarea id="description" name="detail"></textarea>
>>>>>>> ff04bcea937c4e1a9645d2bb90070137e914f1e0:tempWorkspace/sampleapp/src/main/webapp/WEB-INF/views/regist.jsp
